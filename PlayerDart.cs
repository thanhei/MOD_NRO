...
{
	// Token: 0x06000413 RID: 1043 RVA: 0x00026DF8 File Offset: 0x00024FF8
	...
	// Token: 0x06000414 RID: 1044 RVA: 0x000062CA File Offset: 0x000044CA
	...
	// Token: 0x06000415 RID: 1045 RVA: 0x00026E98 File Offset: 0x00025098
	public void update()
	{
		if (!this.isActive)
		{
	...
	// Token: 0x06000416 RID: 1046 RVA: 0x0002725C File Offset: 0x0002545C
	private void endMe()
	{
		...
		if (this.charBelong.isUseSkillAfterCharge)
		{
			...
			if (this.charBelong.cgender == 2)
			{
				...
				if (this.charBelong.me)
				{
					num = (int)global::Char.myCharz().myskill.skillId;
				}
				else
				{
					num = this.charBelong.skillTemplateId;
				}
				if (num < 77 || num > 83)
				{
	...
	// Token: 0x06000417 RID: 1047 RVA: 0x00027400 File Offset: 0x00025600
