...
{
	// Token: 0x06000960 RID: 2400 RVA: 0x00083AE0 File Offset: 0x00081CE0
	public static void load()
	{
		...
		mResources.LOGINLABELS = new string[] { "Chưa có tài khoản xin", "chọn menu đăng ký." };
		mResources.msg = "Tin nhắn";
		mResources.msgg = new string[] { "Tin", "nhắn" };
		...
		mResources.MENUME = new string[] { "Hành trang", "Kỹ năng", "Tiềm năng", "Thông tin", "Trang bị" };
		...
		mResources.MENUGENDER = new string[] { "Trái đất", "Namếc", "Xayda" };
		if (mSystem.clientType == 7)
		{
			mResources.MENUGENDER = new string[] { "Rồng đất", "Rồng xanh", "Rồng đỏ" };
		}
		mResources.CHAR_ORDER = new string[] { "Thách đấu", "Luyện tập", "Cừu sát", "Kết bạn", "Mời vào bang", "Phục hồi", "Xem thông tin", "Chat riêng", "Mời vào tộc", "Chặn xin vào tộc" };
		...
		mResources.key_skill_qwerty = new string[] { "Vào\nphím 1", "Vào\nphím 2", "Vào\nphím 3", "Vào\nphím 4", "Vào\nphím 5", "Vào\nphím 6", "Vào\nphím 7", "Vào\nphím 8", "Vào\nphím 9", "Vào\nphím 0" };
		...
		mResources.DES_TASK = new string[] { "Hãy đi tìm ", " ở ", " để nhận nhiệm vụ.", "Bạn đã hoàn thành hết nhiệm vụ phiên bản này, vui lòng chờ cho đến khi ra phiên bản tiếp theo." };
		mResources.DIES = new string[] { "Kiệt sức", "Chờ", "Về nhà", "Hồi sinh\nngay\n(1 ngọc)" };
		mResources.SYNTHESIS = new string[] { "Bản đồ", "Nhiệm vụ", "Gia tộc" };
		...
		mResources.chestt = new string[] { "Rương", "Đồ" };
		mResources.inventory = new string[] { "Hành", "Trang" };
		mResources.combine = new string[] { "Kết", "hợp" };
		mResources.mapp = new string[] { "Bản", "đồ" };
		mResources.item_give = new string[] { "Item", "cho" };
		mResources.item_receive = new string[] { "Item", "nhận" };
		mResources.zonee = new string[] { "Khu", "Vực" };
		...
		mResources.memberr = new string[] { "Thành", "viên" };
		mResources.chatClan = new string[] { "Chat", "bang" };
		mResources.leaveClan = new string[] { "Rời", "bang" };
		mResources.createClan = new string[] { "Lập", "bang" };
		mResources.findClan = new string[] { "Tìm", "bang" };
		mResources.khau_hieuu = new string[] { "Khẩu", "hiệu" };
		mResources.bieu_tuongg = new string[] { "Biểu", "tượng" };
		mResources.request_pea2 = new string[] { "Xin", "đậu" };
		...
		mResources.clanEmpty = new string[] { "Hiện tại bang chỉ có", " 1 thành viên là bạn.", " Xin chờ có người xin vào.", " Bạn có thể chọn vào nhân vật", " khác để mời họ vào bang" };
		...
		{
			new string[] { "Gohan", "Krillin", "Yamcha" },
			new string[] { "Ốc tiêu", "Pocollo", "Kami" },
			new string[] { "Cađic", "Rađic", "Kakalot" }
		};
		if (mSystem.clientType == 7)
		{
			mResources.hairStyleName = new string[][]
			{
				new string[] { "Hango", "Linkhi", "Chayam" },
				new string[] { "Deden", "Cololo", "Mika" },
				new string[] { "Tageve", "Ditra", "Rotkaka" }
			};
		}
