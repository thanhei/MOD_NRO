...
{
	// Token: 0x06000962 RID: 2402 RVA: 0x00085264 File Offset: 0x00083464
	public static void load()
	{
		...
		mResources.LOGINLABELS = new string[] { "Didn't have account? Please", "choose register menu." };
		...
		mResources.MENUME = new string[] { "Inventory", "Skill", "Potential", "Info", "Equipment" };
		...
		mResources.MENUGENDER = new string[] { "Earth", "Namekian", "Saiyan" };
		if (mSystem.clientType == 7)
		{
			mResources.MENUGENDER = new string[] { "Earth dragon", "Green dragon", "Red dragon" };
		}
		mResources.CHAR_ORDER = new string[] { "Challenge", "Practice", "PK", "Add friend", "Invite clan", "Recover", "Information", "Private chat", "Invite to clan", "Block invite to clan" };
		mResources.mainTab1 = new string[][]
		{
			...
			new string[] { "Inven-", "tory" },
			new string[]
			{
				"Skill",
				string.Empty
			},
			new string[] { "Func-", "tion" }
		};
		...
		mResources.key_skill_qwerty = new string[] { "Add\nkey 1", "Add\nkey 2", "Add\nkey 3", "Add\nkey 4", "Add\nkey 5", "Add\nkey 6", "Add\nkey 7", "Add\nkey 8", "Add\nkey 9", "Add\nkey 0" };
		...
		mResources.DES_TASK = new string[] { "Find ", " at ", " to receive quest.", "You now complete all quests of this version, please wait for upcoming version." };
		mResources.DIES = new string[] { "Exhausted", "Wait", "Return\nhome", "Revive\nnow\n(1 gem)" };
		mResources.SYNTHESIS = new string[] { "Map", "Quest", "Clan" };
		...
		mResources.inventory = new string[] { "Inven-", "tory" };
		...
		mResources.item_give = new string[] { "Give", "item" };
		mResources.item_receive = new string[] { "Receive", "item" };
		...
		mResources.chatClan = new string[] { "Chat", "clan" };
		mResources.leaveClan = new string[] { "Leave", "clan" };
		mResources.createClan = new string[] { "Create", "clan" };
		mResources.findClan = new string[] { "Find", "clan" };
		mResources.khau_hieuu = new string[] { "Slogan" };
		mResources.bieu_tuongg = new string[] { "Icon" };
		mResources.request_pea2 = new string[] { "Request", "bean" };
		...
		mResources.clanEmpty = new string[] { "You are the only one", " member of this clan.", " Someone may request to join.", " You can select other players", " to invite them join clan" };
		...
		mResources.hairStyleName = new string[][]
		{
			...
			new string[] { "Dende", "Piccolo", "Kami" },
			new string[] { "Vegeta", "Raditz", "Kakarot" }
		};
		if (mSystem.clientType == 7)
		{
			mResources.hairStyleName = new string[][]
