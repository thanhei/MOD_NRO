...
{
	// Token: 0x06000964 RID: 2404 RVA: 0x000869D0 File Offset: 0x00084BD0
	public static void load()
	{
		...
		mResources.LOGINLABELS = new string[] { "Tidak memiliki account? Harap", "memilih menu daftar" };
		...
		mResources.MENUME = new string[] { "Inventory", "Kriya", "Potential", "Info", "Perlengkapan" };
		...
		mResources.CHAR_ORDER = new string[] { "Tantangan", "Praktek", "PK", "Tambah teman", "Undang clan", "Recover", "Informasi", "Chat pribadi", "Undang ke clan", "Blok undangan ke clan" };
		...
		mResources.key_skill_qwerty = new string[] { "Tambah\n1", "Tambah\n2", "Tambah\n3", "Tambah\n4", "Tambah\n5", "Tambah\n6", "Tambah\n7", "Tambah\n8", "Tambah\n9", "Tambah\n0" };
		...
		mResources.DES_TASK = new string[] { "Fenemukan", "di", "untuk menerima quest.", "Kamu telah menyelesaikan semua quest di versi ini", "harap menunggu versi yang akan datang." };
		mResources.DIES = new string[] { "Darah habis", "Tunggu", "Kembali ke rumah", "Revive sekarang\n(1 gem)" };
		mResources.SYNTHESIS = new string[] { "Peta", "Penca\n-rian", "Clan" };
		...
		mResources.inventory = new string[] { "Inven-", "taris" };
		mResources.combine = new string[] { "mengga-", "bungkan" };
		mResources.mapp = new string[]
		{
			"Peta",
			string.Empty
		};
		mResources.item_give = new string[] { "membe-", "rikan" };
		mResources.item_receive = new string[] { "mene-", "rima" };
		...
		mResources.leaveClan = new string[] { "Menin-", "ggalkan" };
		mResources.createClan = new string[] { "Memb-", "uat" };
		mResources.findClan = new string[] { "Mene-", "mukan" };
		mResources.khau_hieuu = new string[] { "Slogan" };
		mResources.bieu_tuongg = new string[] { "Icon" };
		mResources.request_pea2 = new string[] { "Permintaan", "kacang" };
		...
		mResources.clanEmpty = new string[] { "Kamulah satu-satunya", "anggota klan ini", "Seseorang bisa meminta untuk bergabung", "Kamu bisa memilih pemain lain", "untuk mengundang mereka ke clan" };
